...
- You can make only announe a wedding if it's your turn to begin the trick, and you have to play one of the two cards after announcing it.
...
- Otherwise the game ends when the deck runs out.
